      ...
      <ul class="space-y-2">
          ...
          <li>
              <a href="{{ route('settings.security.index') }}" 
                 class="flex items-center p-2 text-gray-700 rounded-lg {{ Route::currentRouteName() == 'settings.security' ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-100' }} transition-colors duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
