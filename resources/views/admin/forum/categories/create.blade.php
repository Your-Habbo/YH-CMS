...
<main class="flex-1 overflow-y-auto bg-gray-100">
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('admin.forum-categories.store') }}" method="POST" class="mt-4">
            @csrf
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">Create Category</button>
        </form>
    </div>
</main>
