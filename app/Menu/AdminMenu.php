...
class AdminMenu
{
    private static $menuItems = [
        ['url' => '/dashboard', 'title' => 'Dashboard', 'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6'],
        ['url' => '/users', 'title' => 'Users', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', 'submenu' => [
            ['url' => '/admin/forum/forum-categories', 'title' => 'Dashboared'],
            ['url' => '/users/manage', 'title' => 'Manage Users'],
        ]],
        ...
        $dropdownHtml = '
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open" class="flex items-center w-full py-2 px-4 hover:bg-gray-700 rounded">
                    ' . $icon . '
                    ' . $item['title'] . '
                    <svg class="h-5 w-5 ml-auto" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
                </button>
                <ul x-show="open" class="bg-gray-700 mt-2 py-2 rounded">
        ';
